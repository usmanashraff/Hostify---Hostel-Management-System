...
import { CreateVisitorInput } from "@/types";

// GET /api/visitors?status=inside&date=2025-05-16
...
// POST /api/visitors  — log a new visitor entry
// Requires loggedById in body (the staff member on duty)
